...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($imagePath)) {
        $stmt = $conn->prepare("UPDATE Giftbox SET Name = :name, CategoryId = :cat_id, Description = :description, ImagePath = :image, Price = :price WHERE Id = :id");
        $stmt->bindParam(':image', $imageName, PDO::PARAM_STR);
    } else {
        $stmt = $conn->prepare("UPDATE Giftbox SET Name = :name, CategoryId = :cat_id, Description = :description, Price = :price WHERE Id = :id");
    }
